...
SLACKVERSION=${SLACKVERSION:-"12.1"}
...
# Space separated:
EXCL_256="ap/hplip ap/mysql n/net-snmp n/samba"
EXCL_512="ap/hplip ap/mysql ap/rpm d/clisp d/gcc-java d/gcc-gfortran d/gcc-gnat l/aspell-en l/jre l/lesstiff n/net-snmp n/ntp"
EXCL_1024="d/clisp d/gcc-java d/gcc-gfortran d/gcc-gnat kde/kdeedu kde/kdevelop kde/kdewebdev kde/koffice x/sazanami-fonts-ttf x/tibmachuni-font-ttf x/wqy-zenhei-font-ttf x/xorg-docs xap/seamonkey"
EXCL_2048=""
EXCL_4096=""
...
if [ $OPTION -lt $IMGS_256 ] ; then
  ...
  ADDPKGS="${PKGS_2048}"
  REMPKGS="${EXCL_2048}"
  # Here we include /extra and /testing minus the sources and aspell wordlists
  EXTRAARGS="--exclude bootdisks \
