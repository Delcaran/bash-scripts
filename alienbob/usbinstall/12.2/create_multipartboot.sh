...
FATSIZE=22500       # size of the FAT partition in kB
...
SLACKVERSION=${SLACKVERSION:-"12.2"}
...
# Space separated:
EXCL_256="ap/hplip ap/mysql ap/rpm ap/zsh n/epic4 n/htdig n/ipw2100-fw n/ipw2200-fw n/lynx n/ncftp n/net-snmp n/netatalk n/proftpd n/samba n/yptools n/ytalk n/zd1211-firmware"
EXCL_512="ap/hplip ap/mysql ap/rpm d/clisp d/gcc-java d/gcc-gfortran d/gcc-gnat l/arts l/aspell-en l/gnome-icon-theme l/gtk+ l/gtk+2 l/jre l/lesstiff l/pygtk l/qt n/htdig n/ipw2100-fw n/ipw2200-fw n/lynx n/net-snmp n/ntp n/ncftp"
EXCL_1024="d/clisp d/gcc-java d/gcc-gfortran d/gcc-gnat kde/kdeedu kde/kdevelop kde/kdewebdev kde/koffice l/jre x/sazanami-fonts-ttf x/tibmachuni-font-ttf x/wqy-zenhei-font-ttf x/xorg-docs xap/gimp-help xap/seamonkey"
EXCL_2048=""
EXCL_4096=""
...
while getopts "hcmns" Option
do
  case $Option in
    h ) echo "$0 -chns <imgsize>"
